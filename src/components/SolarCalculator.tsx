  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-200 dark:border-slate-800">
      ...
      <div className="text-center max-w-2xl mx-auto mb-8">
        <div className="inline-flex items-center gap-2 bg-amber-100 dark:bg-amber-900/50 text-amber-800 dark:text-amber-300 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-2">
        ...
        {/* Dual Tab Switcher */}
        <div className="flex justify-center gap-2 mt-6 p-1.5 bg-slate-100 dark:bg-slate-800 rounded-2xl max-w-md mx-auto">
          <button
      ...
      {activeTab === 'bill' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Controls Column */}
          <div className="lg:col-span-5 space-y-6 bg-slate-50 dark:bg-slate-800/60 p-6 rounded-2xl border border-slate-200 dark:border-slate-700">
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`py-3 px-4 rounded-xl font-bold text-xs border transition-all ${
                    propertyType === 'home'
                      ? 'border-blue-600 bg-blue-50 dark:bg-blue-900/40 text-blue-700 dark:text-amber-300 font-black'
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-base font-black text-blue-600 dark:text-amber-400 font-mono">
            ...
            <div className="p-4 bg-amber-500/10 rounded-xl border border-amber-500/30 text-xs text-amber-800 dark:text-amber-200 flex items-start gap-2.5">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-2xl bg-blue-50 dark:bg-slate-800 border border-blue-100 dark:border-slate-700 text-center">
                <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">System Capacity</span>
                <p className="text-2xl font-black text-blue-600 dark:text-amber-400 mt-1">{estimatedKw} kW</p>
                <span className="text-[10px] text-slate-500">Rooftop Plant</span>
              </div>

              <div className="p-4 rounded-2xl bg-emerald-50 dark:bg-slate-800 border border-emerald-100 dark:border-slate-700 text-center">
                <span className="text-[10px] uppercase font-bold text-emerald-600 dark:text-emerald-400">Annual Units</span>
              ...
              <div className="p-4 rounded-2xl bg-amber-50 dark:bg-slate-800 border border-amber-100 dark:border-slate-700 text-center col-span-2 sm:col-span-1">
                <span className="text-[10px] uppercase font-bold text-amber-600 dark:text-amber-400">Roof Area Req.</span>
                <p className="text-2xl font-black text-slate-800 dark:text-slate-100 mt-1">{roofAreaSqFt} sq ft</p>
      ...
      {activeTab === 'emi' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-slate-800 rounded-2xl border border-blue-100 dark:border-slate-700 text-xs text-slate-700 dark:text-slate-300 space-y-2">
              <div className="flex items-center gap-2 font-bold text-blue-700 dark:text-amber-400">
