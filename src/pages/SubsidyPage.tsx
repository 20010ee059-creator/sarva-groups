  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      <div className="text-center max-w-3xl mx-auto space-y-3">
        <div className="inline-flex items-center gap-2 bg-emerald-100 dark:bg-emerald-900/50 text-emerald-800 dark:text-emerald-300 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
          <Sparkles className="w-4 h-4 text-emerald-500" />
          Central Govt Direct Benefit Transfer
        </div>
        <h1 className="text-4xl sm:text-5xl font-black text-slate-900 dark:text-white font-poppins">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {subsidies.map((s) => (
          <div
            key={s.id}
            className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6 relative overflow-hidden flex flex-col justify-between"
          >
            ...
            <button
              ...
              className="w-full bg-slate-900 hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 text-white font-extrabold text-xs py-3 rounded-xl transition-transform active:scale-95 mt-4"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 space-y-6">
          ...
          <div className="space-y-4 text-xs text-slate-700 dark:text-slate-300">
            <div className="p-3 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 flex gap-3">
              ...
              <div>
                <p className="font-bold text-slate-900 dark:text-white">Portal Registration</p>
            ...
            <div className="p-3 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 flex gap-3">
              ...
              <div>
                <p className="font-bold text-slate-900 dark:text-white">Sarva Solar Technical Survey</p>
            ...
            <div className="p-3 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 flex gap-3">
              ...
              <div>
                <p className="font-bold text-slate-900 dark:text-white">Turnkey Installation & Testing</p>
            ...
            <div className="p-3 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 flex gap-3">
              ...
              <div>
                <p className="font-bold text-slate-900 dark:text-white">DISCOM Net Metering</p>
                <p className="text-slate-500">DISCOM inspection and bi-directional Net Meter commissioning.</p>
              </div>
            </div>

            <div className="p-3 bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl border border-emerald-200 dark:border-emerald-800 flex gap-3">
              ...
              <div>
                <p className="font-bold text-emerald-700 dark:text-emerald-300">Direct Subsidy Credit (DBT)</p>
                <p className="text-emerald-600 dark:text-emerald-400">Direct bank account credit of up to ₹78,000 within 30 days of commissioning.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="space-y-3 text-xs">
            {[
              ...
              <div key={idx} className="p-3 bg-slate-50 dark:bg-slate-800 rounded-xl flex items-center gap-3">
          ...
          <div className="p-4 bg-amber-500/10 rounded-2xl border border-amber-500/30 text-xs text-amber-800 dark:text-amber-200 space-y-2">
