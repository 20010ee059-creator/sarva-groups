...
export const AboutPage: React.FC<AboutPageProps> = ({ settings, onNavigate, onOpenQuoteModal }) => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <section className="bg-white dark:bg-slate-900 rounded-3xl p-8 sm:p-12 shadow-xl border border-slate-200 dark:border-slate-800 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        <div className="md:col-span-5 text-center space-y-4">
          <div className="w-48 h-48 rounded-full overflow-hidden mx-auto shadow-2xl border-4 border-amber-500/40">
            <img
              src="/src/assets/images/regenerated_image_1784933875727.jpg"
          ...
          <div>
            ...
            <p className="text-xs text-amber-600 dark:text-amber-400 font-extrabold uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-white font-poppins">Our Vision</h3>
        ...
        <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-white font-poppins">Our Values</h3>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
      ...
      <section className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-xl border border-slate-200 dark:border-slate-800 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 space-y-2">
            ...
            <p className="text-xs font-bold text-slate-800 dark:text-slate-200">Guntur HQ & Coastal Network</p>
          ...
          <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 space-y-2">
            <div className="flex items-center gap-2 text-blue-600 dark:text-amber-400 font-extrabold text-sm">
              <MapPin className="w-4 h-4" />
              <span>State Office: Telangana</span>
            </div>
            <p className="text-xs font-bold text-slate-800 dark:text-slate-200">Hyderabad & Warangal Operations</p>
            <p className="text-xs text-slate-600 dark:text-slate-400">
          ...
          <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 space-y-2">
            ...
            <p className="text-xs font-bold text-slate-800 dark:text-slate-200">Kolkata & Industrial Belts</p>
            <p className="text-xs text-slate-600 dark:text-slate-400">
