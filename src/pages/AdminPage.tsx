...
export const AdminPage: React.FC<AdminPageProps> = ({ user, onLoginSuccess, onLogout }) => {
  ...
  const loadData = async () => {
    if (!user) return;
    try {
      const [l, q, prod, proj, b, svc, sub, test, faq, gal, j, apps, set, ana, vLogs, eMails, uList, hs] = await Promise.all([
        fetchLeads().catch(() => []),
        fetchQuotes().catch(() => []),
        fetchProducts().catch(() => []),
        fetchProjects().catch(() => []),
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'New': return 'bg-blue-100 text-blue-700 dark:bg-blue-900/60 dark:text-blue-300';
      case 'Contacted': return 'bg-amber-100 text-amber-700 dark:bg-amber-900/60 dark:text-amber-300';
      case 'Site Inspection': return 'bg-purple-100 text-purple-700 dark:bg-purple-900/60 dark:text-purple-300';
      case 'Proposal Sent': return 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/60 dark:text-indigo-300';
      case 'Closed Won': return 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/60 dark:text-emerald-300 font-extrabold';
      case 'Closed Lost': return 'bg-red-100 text-red-700 dark:bg-red-900/60 dark:text-red-300';
  ...
  if (!user) {
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <div className="bg-white dark:bg-slate-900 p-8 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl max-w-md w-full space-y-6">
          ...
          {loginError && (
            <div className="p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800/50 text-red-600 dark:text-red-400 text-xs rounded-xl flex items-center gap-2">
          ...
          <form onSubmit={handleLogin} className="space-y-4 text-xs">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3.5 py-2.5 text-slate-900 dark:text-white text-sm"
              />
            </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs bg-amber-100 dark:bg-amber-900/60 text-amber-800 dark:text-amber-300 font-extrabold px-2.5 py-0.5 rounded-full">
                {user.role} Portal
              </span>
            </div>
            <p className="text-xs text-slate-500">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 text-xs font-bold text-slate-700 dark:text-slate-200 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 py-2 px-3.5 rounded-xl border border-slate-200 dark:border-slate-700 transition-colors shadow-sm"
          >
          ...
          <button
            onClick={onLogout}
            className="flex items-center gap-2 text-xs font-bold text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 py-2 px-3.5 rounded-xl border border-red-200 dark:border-red-800 transition-colors"
          >
      ...
      <div className="flex flex-wrap gap-1.5 p-2 bg-slate-100 dark:bg-slate-800/80 rounded-2xl border border-slate-200 dark:border-slate-700 text-xs">
        <button
          onClick={() => setActiveTab('dashboard')}
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'dashboard' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'heroSlides' ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/20' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'settings' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'services' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'products' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'projects' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'blogs' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'subsidies' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'testimonials' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'faqs' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'gallery' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'careers' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'leads' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'quotes' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'visitorLogs' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'emailNotifications' ? 'bg-amber-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
            activeTab === 'staff' ? 'bg-indigo-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
          }`}
        >
        ...
        {user.role === 'Admin' && (
          <button
            ...
            className={`py-2 px-3.5 rounded-xl font-bold transition-all flex items-center gap-1.5 ${
              activeTab === 'audit' ? 'bg-blue-600 text-white shadow' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
            }`}
          >
      ...
      {activeTab === 'dashboard' && analytics && (
        <div className="space-y-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg text-center">
              <span className="text-[10px] font-bold uppercase text-slate-400">Total Leads</span>
              <p className="text-3xl font-black text-blue-600 dark:text-amber-400 mt-1">{analytics.totalLeads}</p>
            ...
            <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg text-center">
              ...
              <p className="text-3xl font-black text-emerald-600 dark:text-emerald-400 mt-1">{analytics.conversionRate}</p>
      ...
      {activeTab === 'settings' && settings && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6 text-xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h4 className="font-extrabold text-slate-900 dark:text-white text-sm">General Branding</h4>
              <div>
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Address (Appears in Header & Footer)</label>
                <textarea
                  rows={3}
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Google Maps Embed URL</label>
                <input
                  type="text"
            ...
            <div className="space-y-4">
              <h4 className="font-extrabold text-slate-900 dark:text-white text-sm">Contact Numbers & Hours</h4>
              <div>
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Secondary Phone</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">WhatsApp Chat Number (Without +)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Working Hours</label>
                <input
                  type="text"
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-slate-800 space-y-4">
            <h4 className="font-extrabold text-slate-900 dark:text-white text-sm">Top Announcement Banner</h4>
            <div>
              <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Announcement Text</label>
              <input
                type="text"
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="showBar" className="font-bold text-slate-800 dark:text-slate-200 cursor-pointer">
      ...
      {activeTab === 'services' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {services.map((svc) => (
              <div key={svc.id} className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/60 space-y-3 relative">
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="font-bold text-base text-slate-900 dark:text-white font-poppins">{svc.title}</h4>
                    <p className="text-xs text-amber-500 font-mono">/services/{svc.slug}</p>
                  </div>
                  <div className="flex gap-2">
                    <button
                      onClick={() => setEditingItem({ type: 'services', data: { ...svc } })}
                      className="p-1.5 bg-blue-100 dark:bg-blue-900/60 text-blue-600 dark:text-blue-300 rounded-lg"
                    >
                    ...
                    {user.role === 'Admin' && (
                      <button
                        ...
                        className="p-1.5 bg-red-100 dark:bg-red-900/60 text-red-600 dark:text-red-300 rounded-lg"
                      >
                ...
                <p className="text-xs text-slate-600 dark:text-slate-300 line-clamp-2">{svc.shortDesc}</p>
      ...
      {activeTab === 'products' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {products.map((p) => (
              <div key={p.id} className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-2 relative shadow-sm">
                <div className="h-36 rounded-xl overflow-hidden bg-slate-100">
                  <img src={p.imageUrl} alt={p.name} className="w-full h-full object-cover" />
                </div>
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="font-bold text-sm text-slate-900 dark:text-white font-poppins">{p.name}</h4>
                    <p className="text-xs text-slate-500">{p.brand} • {p.category}</p>
                  </div>
                  <div className="flex gap-1">
                    <button
                      onClick={() => setEditingItem({ type: 'products', data: { ...p } })}
                      className="p-1 bg-slate-100 dark:bg-slate-800 text-blue-600 dark:text-blue-300 rounded"
                    >
                    ...
                    {user.role === 'Admin' && (
                      <button
                        ...
                        className="p-1 bg-slate-100 dark:bg-slate-800 text-red-600 rounded"
                      >
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-800">
                  <span className="text-sm font-black font-mono text-blue-600 dark:text-amber-400">
      ...
      {activeTab === 'projects' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {projects.map((p) => (
              <div key={p.id} className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/60 space-y-3 relative">
                ...
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="font-bold text-sm text-slate-900 dark:text-white font-poppins">{p.title}</h4>
                    <p className="text-xs text-slate-500">{p.location}, {p.state} • {p.category}</p>
                  </div>
                  <div className="flex gap-1.5">
                    <button
                      onClick={() => setEditingItem({ type: 'projects', data: { ...p } })}
                      className="p-1.5 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-lg text-xs"
                    >
                      <Edit2 className="w-4 h-4" />
                    </button>
                    {user.role === 'Admin' && (
                      <button
                        ...
                        className="p-1.5 bg-red-100 dark:bg-red-900 text-red-600 dark:text-red-300 rounded-lg text-xs"
                      >
                        <Trash2 className="w-4 h-4" />
                      </button>
                    )}
                ...
                <div className="grid grid-cols-2 gap-2 text-xs font-mono bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700">
      ...
      {activeTab === 'blogs' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="space-y-4">
            {blogs.map((b) => (
              <div key={b.id} className="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 bg-blue-100 dark:bg-blue-900/60 text-blue-600 dark:text-blue-300 rounded-xl text-xs font-bold flex items-center gap-1"
                  >
                    <Edit2 className="w-3.5 h-3.5" />
                    <span>Edit</span>
                  </button>
                  {user.role === 'Admin' && (
                    <button
                      ...
                      className="p-2 bg-red-100 dark:bg-red-900/60 text-red-600 dark:text-red-300 rounded-xl text-xs font-bold"
                    >
                      <Trash2 className="w-3.5 h-3.5" />
                    </button>
                  )}
      ...
      {activeTab === 'subsidies' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="space-y-4">
            {subsidies.map((s) => (
              <div key={s.id} className="p-5 bg-slate-50 dark:bg-slate-800/70 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3 text-xs">
                <div className="flex justify-between items-center">
                  <div>
                    <h4 className="font-extrabold text-base text-slate-900 dark:text-white font-poppins">{s.schemeName}</h4>
                    <p className="text-slate-500 font-mono">Range: {s.capacityRange}</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-emerald-600 font-mono font-bold text-sm bg-emerald-50 dark:bg-emerald-900/40 px-3 py-1 rounded-xl">
      ...
      {activeTab === 'testimonials' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {testimonials.map((t) => (
              <div key={t.id} className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/60 space-y-2 relative">
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-3">
                    <img src={t.photoUrl} alt={t.customerName} className="w-10 h-10 rounded-full object-cover shrink-0" />
                    <div>
                      <h4 className="font-bold text-sm text-slate-900 dark:text-white">{t.customerName}</h4>
      ...
      {activeTab === 'faqs' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="space-y-3">
            {faqs.map((f) => (
              <div key={f.id} className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/60 space-y-2">
                <div className="flex justify-between items-start">
                  <div>
                    <span className="text-[10px] font-extrabold uppercase bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">
                      {f.category}
                    </span>
                    <h4 className="font-bold text-sm text-slate-900 dark:text-white mt-1">{f.question}</h4>
                  </div>
                  <div className="flex gap-1">
                    <button
      ...
      {activeTab === 'heroSlides' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-4">
            <div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white font-poppins flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {heroSlides.map((slide, index) => {
              ...
              return (
                <div
                  key={slide.id}
                  className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/60 overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
                >
                  {/* Media Preview Box */}
                ...
                <div className="p-4 space-y-3 flex-1 flex flex-col justify-between">
                  <div className="space-y-1.5">
                    {slide.badge && (
                      <span className="inline-block text-[10px] font-bold text-amber-500 dark:text-amber-400 uppercase tracking-wider bg-amber-500/10 dark:bg-amber-500/20 px-2 py-0.5 rounded-md">
                        {slide.badge}
                      </span>
                    )}
                  ...
                  <div className="pt-3 border-t border-slate-200 dark:border-slate-700/60 flex items-center justify-between">
                    <div className="text-[11px] text-slate-500 space-y-0.5">
                      <p>Primary CTA: <span className="font-bold text-slate-700 dark:text-slate-300">{slide.ctaPrimaryText || 'None'}</span></p>
                      <p>Secondary CTA: <span className="font-bold text-slate-700 dark:text-slate-300">{slide.ctaSecondaryText || 'None'}</span></p>
                    </div>

                    <div className="flex items-center gap-1.5">
                      <button
                        onClick={() => setEditingItem({ type: 'heroSlides', data: { ...slide } })}
                        className="p-2 rounded-lg bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors"
                        title="Edit Slide"
                      >
                        <Edit2 className="w-4 h-4" />
                      </button>
                      ...
                      {user.role === 'Admin' && (
                        <button
                          ...
                          className="p-2 rounded-lg bg-red-50 dark:bg-red-950/40 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors"
                          title="Delete Slide"
                        >
                          <Trash2 className="w-4 h-4" />
                        </button>
      ...
      {activeTab === 'gallery' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {gallery.map((g) => (
              <div key={g.id} className="p-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/60 space-y-2">
      ...
      {activeTab === 'leads' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-slate-50 dark:bg-slate-800/60 p-3 rounded-2xl">
            <div className="relative w-full sm:w-72">
              <input
                ...
                className="w-full bg-white dark:bg-slate-900 text-xs text-slate-900 dark:text-white px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 pr-8"
              />
              ...
              {['All', 'New', 'Contacted', 'Site Inspection', 'Proposal Sent', 'Closed Won'].map((st) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg font-bold ${
                    statusFilter === st ? 'bg-blue-600 text-white' : 'bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300'
                  }`}
                >
                  {st}
                </button>
                ...
                {filteredLeads.map((l) => (
                  <tr key={l.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    <td className="p-3 font-sans font-bold">
                      <p className="text-slate-900 dark:text-white">{l.fullName}</p>
                      <p className="text-[11px] text-slate-500">{l.phone} | {l.email}</p>
                    </td>
                    <td className="p-3 font-sans">
                      <p>{l.state} ({l.city})</p>
                      <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-bold">{l.monthlyBill}</p>
                    </td>
                    ...
                    <td className="p-3">
                      <select
                        value={l.status}
                        onChange={async (e) => {
                          const updated = await updateLead(l.id, { status: e.target.value as any });
            ...
            <table className="w-full text-left text-xs text-slate-700 dark:text-slate-300">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800 font-mono">
                {quotes.map((q) => (
                  <tr key={q.id}>
                    <td className="p-3 font-sans font-bold">
                      <p className="text-slate-900 dark:text-white">{q.name}</p>
                      <p className="text-[11px] text-slate-500">{q.phone} | {q.city}, {q.state}</p>
                    </td>
                    <td className="p-3 font-sans font-extrabold text-blue-600 dark:text-amber-400">
                    ...
                    <td className="p-3">
                      <select
                        value={q.status}
                        onChange={async (e) => {
                          const updated = await updateQuoteStatus(q.id, e.target.value as any);
                          setQuotes(quotes.map((item) => (item.id === q.id ? updated : item)));
                          showToast('Quote status updated');
                        }}
                        className="p-1 rounded bg-slate-100 dark:bg-slate-800 font-sans font-bold text-xs"
                      >
      ...
      {activeTab === 'careers' && (
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white font-poppins flex items-center gap-2">
          ...
          {careersSubTab === 'openings' && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {jobs.map((job) => (
                <div
                  key={job.id}
                  className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-lg space-y-4 flex flex-col justify-between"
                >
                  <div className="space-y-3">
                    <div className="flex justify-between items-start gap-2">
                      <span className="text-[10px] font-extrabold bg-blue-100 dark:bg-blue-900/60 text-blue-700 dark:text-amber-300 px-3 py-1 rounded-full uppercase">
                        {job.type}
                      </span>
                      <button
                        onClick={async () => {
                    ...
                    <h4 className="text-base font-bold text-slate-900 dark:text-white font-poppins">{job.title}</h4>
                    ...
                    <p className="text-xs text-slate-600 dark:text-slate-400 line-clamp-3">{job.desc}</p>
                    <p className="text-xs font-bold text-emerald-600 dark:text-emerald-400">Req: {job.exp}</p>
                  </div>
                  ...
                  {user.role !== 'Employee' && (
                    <div className="flex items-center gap-2 pt-3 border-t border-slate-100 dark:border-slate-800">
                      <button
                        ...
                        className="flex-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 text-slate-800 dark:text-slate-200 font-bold text-xs py-2 rounded-xl flex items-center justify-center gap-1.5"
                      >
                        <Edit2 className="w-3.5 h-3.5" />
                        Edit
                      </button>
                      {user.role === 'Admin' && (
                        <button
                          ...
                          className="bg-red-50 dark:bg-red-950/40 hover:bg-red-100 text-red-600 dark:text-red-400 font-bold text-xs p-2 rounded-xl"
                        >
                          <Trash2 className="w-4 h-4" />
                        </button>
                      )}
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {jobApplications.map((app) => (
                      <tr key={app.id}>
                        ...
                        <td className="p-3 font-bold text-blue-600 dark:text-amber-400">
                          {app.role}
                        </td>
                        <td className="p-3 max-w-xs text-slate-600 dark:text-slate-300">
                          <p className="font-semibold text-emerald-600 dark:text-emerald-400">{app.experience}</p>
                        ...
                        <td className="p-3">
                          <select
                            value={app.status}
                            onChange={async (e) => {
                              const updated = await updateJobApplicationStatus(app.id, e.target.value as any);
                              setJobApplications(jobApplications.map((a) => (a.id === app.id ? updated : a)));
                              showToast(`Application status set to ${updated.status}`);
                            }}
                            className="p-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 font-bold text-xs border border-slate-200 dark:border-slate-700"
                          >
                            <option>New</option>
                        ...
                        <td className="p-3 text-right">
                          <button
                            ...
                            className="text-red-500 hover:bg-red-50 dark:hover:bg-red-950/40 p-1.5 rounded-xl transition-colors"
                          >
                            <Trash2 className="w-4 h-4" />
                          </button>
                        </td>
      ...
      {activeTab === 'audit' && user.role === 'Admin' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-4">
          ...
          <div className="space-y-2">
            {auditLogs.map((log) => (
              <div key={log.id} className="p-3 bg-slate-50 dark:bg-slate-800 rounded-xl text-xs flex justify-between items-center font-mono">
                <div>
                  <span className="font-bold text-blue-600 dark:text-amber-400 mr-2">[{log.action}]</span>
      ...
      {activeTab === 'visitorLogs' && (
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <span className="bg-blue-100 text-blue-800 dark:bg-blue-900/60 dark:text-blue-300 font-extrabold text-xs px-3.5 py-1.5 rounded-full">
                ...
                {visitorLogs.length === 0 ? (
                  ...
                  visitorLogs.map((log) => (
                    <tr key={log.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors">
                      <td className="p-3 font-sans font-bold text-blue-600 dark:text-amber-400">
                        {log.path}
                      </td>
                      <td className="p-3 font-sans text-slate-700 dark:text-slate-300">
                        <span className="font-semibold text-slate-900 dark:text-white mr-2">{log.deviceType}</span>
                        <span className="text-[10px] text-slate-400 truncate max-w-xs block">{log.userAgent}</span>
                      </td>
                      <td className="p-3 text-slate-600 dark:text-slate-400">{log.ip}</td>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-amber-100 text-amber-900 dark:bg-amber-900/60 dark:text-amber-200 text-xs font-black px-4 py-2 rounded-2xl border border-amber-300 dark:border-amber-700">
          ...
          <div className="space-y-4">
            {emailNotifications.length === 0 ? (
              <div className="p-12 text-center text-slate-500 bg-slate-50 dark:bg-slate-800/40 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700">
              ...
              emailNotifications.map((e) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs bg-white dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                    <div>
                      <span className="text-slate-400 block text-[10px] uppercase font-bold">Customer Name</span>
                      <strong className="text-slate-800 dark:text-slate-100">{e.customerName}</strong>
                    </div>
                    <div>
                      <span className="text-slate-400 block text-[10px] uppercase font-bold">Email Address</span>
                      <span className="text-blue-600 dark:text-amber-400 font-medium">{e.customerEmail}</span>
                    </div>
                    <div>
                      <span className="text-slate-400 block text-[10px] uppercase font-bold">Phone Number</span>
                      <span className="text-slate-800 dark:text-slate-100 font-mono">{e.customerPhone}</span>
                    </div>
                  </div>

                  <div className="text-xs text-slate-700 dark:text-slate-300 bg-slate-100/70 dark:bg-slate-800/70 p-3 rounded-xl font-mono">
                  ...
                  {(e.deliveryMethod || e.errorMessage) && (
                    <div className="text-[11px] p-2.5 rounded-lg bg-slate-200/60 dark:bg-slate-800/80 text-slate-600 dark:text-slate-300 font-mono">
                      {e.deliveryMethod && <div><strong className="text-emerald-600 dark:text-emerald-400">Method:</strong> {e.deliveryMethod}</div>}
                          ...
                          <td className="p-3">
                            <div className="flex items-center gap-2.5">
                              ...
                              <div>
                                ...
                                {isSelf && (
                                  <span className="text-[10px] bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 px-1.5 py-0.5 rounded font-mono">
                                    Current Session
                                  </span>
                                )}
                              </div>
                            ...
                            <td className="p-3 text-right">
                              <div className="flex items-center justify-end gap-1.5">
                                <button
                                  ...
                                  className="p-1.5 text-slate-600 hover:text-blue-600 dark:text-slate-300 dark:hover:text-amber-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors"
      ...
      {showStaffModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl relative space-y-6 animate-fadeIn">
            ...
            <form onSubmit={handleSaveStaff} className="space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2.5 rounded-xl text-slate-900 dark:text-white text-sm"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2.5 rounded-xl text-slate-900 dark:text-white text-sm font-mono"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2.5 rounded-xl text-slate-900 dark:text-white text-sm font-semibold"
                >
              ...
              <div className="pt-2 flex justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setShowStaffModal(false)}
                  className="px-4 py-2.5 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 font-bold text-xs"
                >
                  Cancel
                </button>
                <button
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl relative space-y-6 animate-fadeIn">
            ...
            >
              ...
              <div className="pt-3 border-t border-slate-200 dark:border-slate-800 space-y-3">
                <p className="font-bold text-slate-900 dark:text-white text-xs">Change Password (Optional)</p>
                <div>
      ...
      {deleteConfirmTarget && (
        <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 max-w-sm w-full shadow-2xl space-y-5 animate-fadeIn">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 rounded-2xl shrink-0">
...
const EditModal: React.FC<EditModalProps> = ({ type, data, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-2xl w-full p-6 space-y-5 shadow-2xl my-8">
        <div className="flex justify-between items-center border-b border-slate-200 dark:border-slate-800 pb-3">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white capitalize font-poppins">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2.5 rounded-xl text-slate-900 dark:text-white font-mono text-xs"
                />
                {formData.mediaType === 'video' && (
                ...
                {formData.mediaUrl && (
                  <div className="mt-2 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 h-36 bg-slate-950 relative">
                    {formData.mediaType === 'video' ? (() => {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-slate-100 dark:border-slate-800">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2.5 rounded-xl text-slate-900 dark:text-white font-semibold"
                  >
          ...
          {type === 'services' && (
            <>
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Service Title</label>
                <input
                  type="text"
                  required
                  value={formData.title || ''}
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Short Summary Description</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Full Detailed Description</label>
                <textarea
                  rows={3}
                  required
          ...
          {type === 'products' && (
            <>
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Warranty Term</label>
                <input
                  type="text"
          ...
          {type === 'projects' && (
            <>
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Capacity (kWp)</label>
                  <input
                    type="number"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Location City</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Annual Savings ₹</label>
                  <input
                    type="number"
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Main Image URL</label>
                <input
                  type="text"
          ...
          {type === 'blogs' && (
            <>
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Markdown Body Content</label>
                <textarea
                  rows={4}
                  value={formData.content || ''}
                  onChange={(e) => setFormData({ ...formData, content: e.target.value })}
                  className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2.5 rounded-xl text-slate-900 dark:text-white font-mono"
                />
              </div>
            </>
          )}
          ...
          {type === 'subsidies' && (
            <>
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Scheme Name</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Capacity Slab</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Central Subsidy ₹</label>
                  <input
                    type="number"
          ...
          {type === 'testimonials' && (
            <>
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Review Comment</label>
                <textarea
                  rows={3}
          ...
          {type === 'gallery' && (
            <>
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Media URL</label>
                <input
                  type="text"
                  required
                  value={formData.mediaUrl || ''}
          ...
          {type === 'careers' && (
            <>
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Experience Requirement *</label>
                <input
                  type="text"
                  required
                  value={formData.exp || ''}
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Job Description & Responsibilities *</label>
                <textarea
                  rows={4}
                  required
                  value={formData.desc || ''}
              ...
              <div className="flex items-center gap-2 pt-1">
                ...
                />
                <label htmlFor="isActive" className="font-bold text-slate-700 dark:text-slate-300 select-none">
