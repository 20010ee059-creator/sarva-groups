    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredProducts.map((p) => (
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-xl space-y-4 hover:shadow-2xl transition-all flex flex-col justify-between group"
          >
            <div className="space-y-4">
              ...
              <div className="px-6 space-y-2">
                ...
                <h3 className="text-base font-bold text-slate-900 dark:text-white font-poppins leading-snug">
                  {p.name}
                </h3>
            ...
            <div className="px-6 pb-6 pt-2 space-y-3">
              ...
              <button
                ...
                className="w-full bg-slate-900 hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 text-white font-extrabold text-xs py-2.5 rounded-xl shadow-md transition-transform active:scale-98"
              >
      ...
      {selectedProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 max-w-lg w-full border border-slate-200 dark:border-slate-800 shadow-2xl relative space-y-4">
            <button
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-white font-poppins">{selectedProduct.name}</h3>
              </div>
            </div>
              ...
              <div className="space-y-1.5 font-mono">
                {Object.entries(selectedProduct.specs).map(([k, v]) => (
                  <div key={k} className="flex justify-between border-b border-slate-200 dark:border-slate-700 pb-1">
                    <span className="text-slate-500 dark:text-slate-400 font-sans">{k}:</span>
            ...
            <div className="p-3 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-800/50 text-xs text-amber-800 dark:text-amber-200 flex items-center gap-2">
