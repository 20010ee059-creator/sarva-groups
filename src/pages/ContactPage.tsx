...
export const ContactPage: React.FC<ContactPageProps> = ({ settings }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 space-y-3">
            <h4 className="font-bold text-sm text-slate-900 dark:text-white font-poppins">Other Regional Hubs</h4>
        ...
        <div className="lg:col-span-7 bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          <h3 className="text-2xl font-bold text-slate-900 dark:text-white font-poppins">
            Send an Inquiry Form
          </h3>

          {submitted ? (
            <div className="p-8 bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl border border-emerald-200 text-center space-y-3">
              <CheckCircle2 className="w-12 h-12 text-emerald-500 mx-auto" />
              <h4 className="text-xl font-bold text-emerald-800 dark:text-emerald-200">Thank You!</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Solar For</label>
                  <select
                    value={form.solarFor}
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Monthly Electricity Bill</label>
                  <select
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Message / Roof Details</label>
                <textarea
                  rows={3}
      ...
      {/* Google Maps Embed */}
      <div className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-xl h-96 relative">
        <iframe
