    ...
    <div className="space-y-20 pb-16">
      ...
      >
        ...
        {activeSlide.mediaType === 'video' && activeVideoInfo ? (
          ...
          <img
            ...
            alt={activeSlide.title || "Sarva Solar"}
            className="absolute inset-0 w-full h-full object-cover opacity-75 scale-105 transition-all duration-1000 animate-fadeIn"
          />
        )}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white font-poppins mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <motion.div
            ...
            className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl space-y-4 hover:border-amber-500/50 transition-all group cursor-pointer"
          >
          ...
          <motion.div
            whileHover={{ y: -6, scale: 1.02 }}
            transition={{ type: 'spring', stiffness: 300, damping: 20 }}
            className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl space-y-4 hover:border-emerald-500/50 transition-all group cursor-pointer"
          >
          ...
          <motion.div
            whileHover={{ y: -6, scale: 1.02 }}
            transition={{ type: 'spring', stiffness: 300, damping: 20 }}
            className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl space-y-4 hover:border-blue-500/50 transition-all group cursor-pointer"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <button
              ...
              className="mt-4 md:mt-0 text-sm font-extrabold text-blue-600 dark:text-amber-400 hover:underline flex items-center gap-1"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => (
              <motion.div
                ...
                transition={{ type: 'spring', stiffness: 300, damping: 20 }}
                className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-lg border border-slate-100 dark:border-slate-800 cursor-pointer group hover:shadow-2xl transition-all"
              >
                ...
                <div className="p-6 space-y-3">
                  ...
                  <div className="pt-2 flex items-center justify-between text-xs font-extrabold text-blue-600 dark:text-amber-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.slice(0, 2).map((project) => (
            <motion.div
              ...
              whileHover={{ y: -8, scale: 1.02 }}
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
              className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-xl border border-slate-100 dark:border-slate-800 space-y-4 hover:shadow-2xl transition-all cursor-pointer group"
            >
              ...
              <div className="p-6 space-y-3">
                ...
                {project.clientReview && (
                  <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl text-xs space-y-1 italic text-slate-700 dark:text-slate-300">
                    <p>"{project.clientReview.comment}"</p>
                    <p className="font-bold not-italic text-amber-600 dark:text-amber-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t) => (
              <motion.div
                ...
                transition={{ type: 'spring', stiffness: 300, damping: 20 }}
                className="bg-slate-800/80 rounded-3xl p-6 border border-slate-700 space-y-4 flex flex-col justify-between hover:border-amber-500/50 transition-colors"
              >
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-slate-700">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400">{t.location} ({t.systemSizeKw}kW System)</p>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-3xl font-black text-slate-900 dark:text-white font-poppins mt-1">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full text-left p-5 font-bold text-sm text-slate-900 dark:text-white flex justify-between items-center gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50"
                >
